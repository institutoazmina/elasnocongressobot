...
if __name__ == "__main__":
    ...
    themes = {
        ...
        "clima": "acordo de paris, ambientais, ambiental, ambiente, aquecimento global, biodiversidade, biodiversidades, carbono, clima, climas, climática, climáticas, climático, climáticos, comunidades tradicionais, contribuições nacionalmente determinadas, desastre natural, desastres naturais, efeito estufa, eficiência energética, emissão de gases, emissões de gases, enchente, energias renováveis, eventos extremos, floresta, florestal, florestas, infraestrutura urbana, naturais, natural, plano de adaptação, planos de adaptação, planos de mitigação, poluição, populações vulneráveis, recursos hídricos, reflorestamento, sustentável, florestais"
    }
